...
import Dropdown from 'js/bootstrap/src/dropdown'; // Share button
import Modal from 'js/bootstrap/src/modal'; // Primary menu
import Offcanvas from 'js/bootstrap/src/offcanvas'; // Filter
